...
$('#bc').on('click', function(){
  ...
  bcGetter.done(function(response){
    ...
    $('#t2').html("<div class='box info t1'><h3 id='t2'>&#x2744 Conditions: "+bcConditions+"</h3>")
    $('#t3').html("<div class='box info t1'><h3 id='t3'>&#x2744 Last Snow Date: "+bcLstSnow+"</h3>")
    $('#t4').html("<div class='box info t1'><h3 id='t4'>&#x2744 Snow Base: "+bcBase+"</h3>")
    $('#t5').html("<div class='box info t1'><h3 id='t5'>&#x2744 Powder: "+bcPowder+"</h3>")
    // $('#t1').toggle(800,"swing");
    // $('#t2').toggle(1000,"swing");
    // $('#t3').toggle(1200,"swing");
    // $('#t4').toggle(1400,"swing");
...
//not getting a vgetter response start there
$('#vl').on('click', function(){
  vGetter.done(function(response){
    var conditions = response.weather.snow_report[0].conditions;
    var lstSnow = response.weather.snow_report[0].last_snow_date;
    var base = response.weather.snow_report[0].lower_snow_depth;
    var powder = response.weather.snow_report[0].upper_snow_depth;
    ...
    $('#t2').html("<div class='box info t1'><h3 id='t2'>&#x2744 Conditions: "+conditions+"</h3>")
    $('#t3').html("<div class='box info t1'><h3 id='t3'>&#x2744 Last Snow Date: "+lstSnow+"</h3>")
    $('#t4').html("<div class='box info t1'><h3 id='t4'>&#x2744 Snow Base: "+base+"</h3>")
    $('#t5').html("<div class='box info t1'><h3 id='t5'>&#x2744 Powder: "+powder+"</h3>")
    // $('#t1').toggle(800,"swing");
    // $('#t2').toggle(1000,"swing");
    // $('#t3').toggle(1200,"swing");
    // $('#t4').toggle(1400,"swing");
